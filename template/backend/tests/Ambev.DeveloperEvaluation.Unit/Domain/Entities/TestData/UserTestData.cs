...
public static class UserTestData
{
    ...
    private static readonly Faker<User> UserFaker = new Faker<User>()
        ...
        .RuleFor(u => u.PasswordHash, f => $"hashed_{f.Random.AlphaNumeric(32)}")
    ...
    /// The generated hash will:
    /// - Be a random string of 32 characters
    /// - Start with "hashed_" prefix
    /// </summary>
    /// <returns>A valid password hash.</returns>
    public static string GenerateValidPasswordHash()
    {
        return $"hashed_{new Faker().Random.AlphaNumeric(32)}";
    }
    ...
    /// <summary>
    /// Generates an invalid password hash for testing negative scenarios.
    /// The generated hash will:
    /// - Be empty
    /// This is useful for testing password hash validation error cases.
    /// </summary>
    /// <returns>An invalid password hash.</returns>
    public static string GenerateInvalidPasswordHash()
    {
        return string.Empty;
    }
